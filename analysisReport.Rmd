...
The distribution is somewhat __positively skewed__ as we can notice the slight long tailed histogram which indicates that the *mean(age) > median(age)* values.
