...
#barplot of Gender
hchart(SurveyDf$GenderSelect,type="bar",name="Gender",color="green") %>%
  hc_exporting(enabled = TRUE) %>%
  hc_title(text="Barplot of gender",align="center") %>%
  hc_add_theme(hc_theme_elementary()) 

#barplot of Emp_status
hchart(SurveyDf$EmploymentStatus,type="bar",name="Employment Status",color="red") %>% 
  hc_exporting(enabled = TRUE) %>%
...
#barplot of country
hchart(SurveyDf$Country,type="bar",name="Country",color="blue") %>% 
  hc_exporting(enabled = TRUE) %>%
...
hchart(na.omit(SurveyDf$Age),name="Age",color="orange") %>%
